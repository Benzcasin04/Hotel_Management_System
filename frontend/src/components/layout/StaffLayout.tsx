...
import {
  Hotel, LayoutDashboard, BedDouble, CalendarCheck,
  ClipboardList, LogOut, ChevronLeft, Menu,
} from 'lucide-react';
...
const StaffLayout = () => {
  ...
  const links = [
    ...
    { to: '/staff/front-desk', label: 'Front Desk', icon: CalendarCheck },
    { to: '/staff/housekeeping', label: 'Housekeeping', icon: BedDouble },
    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 overflow-auto">
        <header className="sticky top-0 z-40 flex h-16 items-center border-b border-border bg-card/95 px-6 backdrop-blur">
          <h2 className="font-heading text-lg font-semibold text-foreground">Staff Portal</h2>
